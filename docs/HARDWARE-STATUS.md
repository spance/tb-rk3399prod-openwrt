...
| USB3 Type-C | 硬件高速已确认，自动重连待验收 | 正反插 CC/角色/VBUS 正常；DWC3_0 手工重绑后 Lexar E300 以 UAS/5000M 枚举，4 GiB direct read 约 349 MiB/s 且无 USB/UAS/SCSI 错误。工程已改用内核 `usb-role-switch` 自动重建 xHCI，待新镜像完成交替方向热插拔、长时读写和 Loader 回归 |
