...
- [Toybrick 原厂 TB-RK3399ProD DTS（FUSB302、VBUS 和 Type-C0 连线依据）](https://github.com/rockchip-toybrick/kernel/blob/stable/arch/arm64/boot/dts/rockchip/rk3399pro-toybrick-prod.dtsi)
...
- [Linux v6.12.94 DWC3 static-host and generic PHY `set_mode` ordering](https://github.com/gregkh/linux/blob/v6.12.94/drivers/usb/dwc3/core.c)
