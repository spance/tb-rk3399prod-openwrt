...
- USB2 EHCI/OHCI、两组 USB3 控制器、板载 Hub 电源和复位；蓝色 Type-A 口已实测高速读写。Type-C 使用固定 host 的 DWC3_0/xHCI、tcphy0、I2C8 FUSB302 和 TCPM orientation switch，连接器固定为 5 V source/host；C 口 SuperSpeed 已实测，常驻 xHCI 的自动换向重连待新镜像验收，详见 [USB Type-C SuperSpeed 主机](USB-TYPE-C.md)。
